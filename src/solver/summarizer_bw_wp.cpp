...
#include "summarizer_bw_wp.h"
#include "summary_db.h"

/*******************************************************************\

Function: summarizer_bw_wpt::summarize
...
void summarizer_bw_wpt::summarize()
{
...
void summarizer_bw_wpt::summarize(const function_namet &function_name)
{
  status() << "\nBackward analysis..." << eom;
...
Function: summarizer_bw_wpt::compute_summary_rec
...
void summarizer_bw_wpt::compute_summary_rec(
...
Function: summarizer_bw_wpt::do_summary
...
void summarizer_bw_wpt::do_summary(
  const function_namet &function_name,
  local_SSAt &SSA,
...
Function: summarizer_bw_wpt::inline_summaries
...
void summarizer_bw_wpt::inline_summaries(
  const function_namet &function_name,
  local_SSAt &SSA,
  const summaryt &old_summary,
  const exprt &postcondition,
...
Function: summarizer_bw_wpt::collect_postconditions
...
void summarizer_bw_wpt::collect_postconditions(
  const function_namet &function_name,
...
Function: summarizer_bw_wpt::check_postcondition
...
bool summarizer_bw_wpt::check_postcondition(
  const function_namet &function_name,
  const local_SSAt &SSA,
...
Function: summarizer_bw_wpt::compute_calling_context2()
...
exprt summarizer_bw_wpt::compute_calling_context2(
  const function_namet &function_name,
  local_SSAt &SSA,
