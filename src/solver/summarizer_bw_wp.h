...
#ifndef CPROVER_2LS_SOLVER_SUMMARIZER_BW_WP_H
#define CPROVER_2LS_SOLVER_SUMMARIZER_BW_WP_H
...
class summarizer_bw_wpt:public summarizer_baset
{
public:
  explicit summarizer_bw_wpt(
    optionst &_options,
